...
from webApi2.models import db, User, Course, Chapter
...
def iter_courses():
    ...
    with open(os.path.join(os.path.dirname(__file__), '..', 'datas', 'courses.json'), encoding='UTF-8') as f:
        courses = json.load(f)
